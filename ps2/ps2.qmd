...
<<<<<<< Updated upstream:ps2/ps2.qmd
  # your code here: exclude subjects that are marked as "DoNotUse"

=======
# Keep observations where DoNotUse is NA
# Observations that we want to drop are marked '1' for DoNotUse
>>>>>>> Stashed changes:ps2.qmd
```
...
=======
         -starts_with("Game"))
# remove columns with "Game" in the name
...
performance_hyp_long_d = performance_hyp_long_d |>
  mutate(
    ...
    # grepl tests whether a string is contained in the column name
